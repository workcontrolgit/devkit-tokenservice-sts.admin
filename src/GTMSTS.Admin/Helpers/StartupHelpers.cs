...
using GTMSTS.Admin.ExceptionHandling;
using GTMSTS.Admin.Configuration;
using GTMSTS.Admin.Configuration.ApplicationParts;
using GTMSTS.Admin.Configuration.Constants;
using GTMSTS.Admin.Configuration.Interfaces;
using Skoruba.IdentityServer4.Admin.EntityFramework.Interfaces;
using Skoruba.IdentityServer4.Admin.EntityFramework.Repositories;
using Skoruba.IdentityServer4.Admin.EntityFramework.Repositories.Interfaces;
using GTMSTS.Admin.Helpers.Localization;
using System.Linq;
...
namespace GTMSTS.Admin.Helpers
{
