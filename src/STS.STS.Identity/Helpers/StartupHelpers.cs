...
using SendGrid;
using STS.Shared.Configuration.Email;
using STS.Shared.Email;
using STS.STS.Identity.Configuration;
using STS.STS.Identity.Configuration.ApplicationParts;
using STS.STS.Identity.Configuration.Constants;
using STS.STS.Identity.Configuration.Interfaces;
using STS.STS.Identity.Helpers.Localization;
using System.Linq;
using Skoruba.IdentityServer4.Admin.EntityFramework.Interfaces;
using STS.Admin.EntityFramework.MySql.Extensions;
using STS.Admin.EntityFramework.PostgreSQL.Extensions;
using STS.Admin.EntityFramework.Shared.Configuration;
using STS.Admin.EntityFramework.SqlServer.Extensions;
using Skoruba.IdentityServer4.Admin.EntityFramework.Helpers;
using Microsoft.AspNetCore.DataProtection.EntityFrameworkCore;
using Microsoft.AspNetCore.Http;
using STS.Shared.Authentication;
using STS.Shared.Configuration.Identity;

namespace STS.STS.Identity.Helpers
{
