...
using GTMSTS.Admin.Api.AuditLogging;
using GTMSTS.Admin.Api.Configuration;
using GTMSTS.Admin.Api.Configuration.ApplicationParts;
using GTMSTS.Admin.Api.Configuration.Constants;
using GTMSTS.Admin.Api.Helpers.Localization;
...
namespace GTMSTS.Admin.Api.Helpers
{
