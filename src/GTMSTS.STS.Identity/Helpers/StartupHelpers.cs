...
using SendGrid;
using GTMSTS.Shared.Configuration.Email;
using GTMSTS.Shared.Email;
using GTMSTS.STS.Identity.Configuration;
using GTMSTS.STS.Identity.Configuration.ApplicationParts;
using GTMSTS.STS.Identity.Configuration.Constants;
using GTMSTS.STS.Identity.Configuration.Interfaces;
using GTMSTS.STS.Identity.Helpers.Localization;
using System.Linq;
using Skoruba.IdentityServer4.Admin.EntityFramework.Interfaces;
using GTMSTS.Admin.EntityFramework.MySql.Extensions;
using GTMSTS.Admin.EntityFramework.PostgreSQL.Extensions;
using GTMSTS.Admin.EntityFramework.Shared.Configuration;
using GTMSTS.Admin.EntityFramework.SqlServer.Extensions;
using Skoruba.IdentityServer4.Admin.EntityFramework.Helpers;
using Microsoft.AspNetCore.DataProtection.EntityFrameworkCore;
using Microsoft.AspNetCore.Http;
using GTMSTS.Shared.Authentication;
using GTMSTS.Shared.Configuration.Identity;

namespace GTMSTS.STS.Identity.Helpers
{
